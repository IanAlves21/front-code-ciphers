  ...
  <div class="extended-forms">
    <card>
      <div class="col-12">
        ...
        <div>
          <h2>Subir Arquivo</h2>
          <input style="margin-top: 15px; border-color: #23CCEF;" class="btn btn-default btn-outline" type="file" id="file" ref="file" @change="onFileChange" />
        </div>
        <div>
          <Button style="margin-top: 15px; border-color: #23CCEF;" stype="button" class="btn btn-default btn-outline" @click="sendAlgoritmo"
            >Enviar</Button
          >
        </div>
      </div>
